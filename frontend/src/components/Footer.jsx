      ...
      <div className="bg-slate-900 text-white py-6 px-4 sm:px-8 text-center">
        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-0">
          ...
          <div className="w-full md:w-3/12">
            <div className="border-b pb-4 border-white text-xl hover:text-amber-300 transition duration-500">
              Navigate
            </div>
            <ul className="flex flex-col pt-4">
              <li className="m-auto cursor-pointer hover:scale-105 transition duration-300">
                <NavLink to="/">Home</NavLink>
              </li>
              <li className="m-auto pt-2 cursor-pointer hover:scale-105 transition duration-300">
          ...
          <div className="w-full md:w-6/12">
            <h2 className="mb-3 font-bold text-3xl hover:text-amber-300 transition duration-500">
              TrackHire
            </h2>
          ...
          <div className="w-full md:w-3/12">
            <div>
              <div
               ...
               text-xl hover:text-amber-300 transition duration-500"
              >
                For Job Seekers
              </div>
              ...
              <ul className="space-y-3 pt-4">
                <li className="m-auto pt-2 cursor-pointer hover:scale-105 transition duration-300">
                  <NavLink to="/signup">Create Profile </NavLink>
                </li>
                <li className="m-auto pt-2 cursor-pointer hover:scale-105 transition duration-300">
                ...
                <li className="m-auto pt-2 cursor-pointer hover:scale-105 transition duration-300">
                  <NavLink to="/jobs">Job Alerts</NavLink>
                </li>
              </ul>
            </div>
          </div>
...
// TODO - email Id i am asking need to check where to use that
